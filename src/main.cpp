...
static int64 nTargetSpacing = 10 * 60;    //10 minute blocks
...
//                           (pindex->nHeight==91880 && pindex->GetBlockHash() == uint256("0x00000000000743f190a18c5577a3c2d2a1f610ae9601ac046a38084ccb7cd721")));
    ...
    // BIP16 will be enabled for Devcoin on 2013-09-01 0:00 UTC
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    else if (strCommand == "getheaders")
    {
		...
		try
		{
			...
			printf("Exception in getheaders");
		}
    }
...
CBlockTemplate* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    for (int i=0; i<coinAddressStrings.size(); i++)
    {
		...
		if(!addr.IsValid())
		{
			printf("CBitcoinAddress not valid! %s\n", coinAddressString.c_str());
			return NULL;
		}
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    {
        printf("DevcoinMiner terminated\n");
        throw;
    }
}
